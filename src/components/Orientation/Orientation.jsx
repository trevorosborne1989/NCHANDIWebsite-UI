      ...
      <Box ml={1} mr={1}>
        <Grid sm={12} container spacing={1} justifyContent={'center'} >
          ...
          <Grid container sm={10} md={5} justifyContent={'center'} alignItems={'center'} direction={'column'} pb={7}>
            <Grid sm={10}>
              <List sx={{fontSize: '30px', color: 'white', listStyleType: 'disc', pl: 3, '& .MuiListItem-root': {display: 'list-item',}, }}>
                <ListItem>
                  <Typography variant='h5' color='white' pb={1} pl={3} pr={3}>
          ...
          <Grid sm={12} container sx={{backgroundColor: nchandiTheme.handiDarkGreen }} py={3} pb={7} >
            ...
            <Grid container sm={12} alignItems={'center'} justifyContent={'center'} textAlign={'center'} pb={7}>
              <Grid sm={10} pb={7}>
                <Box
                  component="img"
